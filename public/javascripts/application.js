...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/header"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="navbar navbar-fixed-top">\n  <div class="navbar-inner">\n    <div class="container">\n \n      <!-- .btn-navbar is used as the toggle for collapsed navbar content -->\n      <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </a>\n \n      <!-- Be sure to leave the brand out there if you want it shown -->\n      <a class="brand" href="#">Driver services</a>\n \n      <!-- Everything you want hidden at 940px or less, place within here -->\n      <div class="nav-collapse">\n        <ul class="nav">\n          <li><a href="#">Home</a></li>\n          <li><a href="#info">Info</a></li>\n          <li><a href="#map">Map</a></li>\n        </ul>\n        <form class="navbar-search pull-left" id="header_search_form">\n          <input name="destination" type="text" class="search-query" placeholder="Enter new destination">\n        </form>\n      </div>\n \n    </div>\n  </div>\n</div>\n');
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/info"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this.start_address));
      
        __out.push('</p>\n\t<h3>To:</h3>\n  <p>');
      
        __out.push(__sanitize(this.end_address));
      
        __out.push('</p>\n\t<h3>Duration:</h3>\n  <p>');
      
        __out.push(__sanitize(this.duration));
      
        __out.push('</p>\n\t<h3>Warnings:<h3>\n\t<img src="/img/glyphicons_021_snowflake.png"/>\n\t<img src="/img/glyphicons_026_road.png"/>\n\t<img src="/img/glyphicons_078_warning_sign.png"/>\n\t<img src="/img/glyphicons_092_tint.png"/>\n  <div class="form-actions">\n    <a href="#map" class="btn btn-large" style=display:block;">To the map!</a>\n  </div>\n</div>\n');
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/map"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        __out.push('<div class="row">\n  <div id="map_canvas">\n  </div>\n  <div class="navbar navbar-fixed-bottom">\n    <div class="navbar-inner">\n      <div class="container">\n        <div class="nav-collapse">\n            <div class="btn-group">\n              <button data-toggle="button" class="btn btn-primary toggle-traffic">Traffic</button>\n              <button data-toggle="button" class="btn btn-primary toggle-conditions">Weather</button>\n              <button data-toggle="button" class="btn btn-primary toggle-places">Services</button>\n              <button data-toggle="button" class="btn btn-primary toggle-places">Directions</button>\n            </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n');
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/search"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
